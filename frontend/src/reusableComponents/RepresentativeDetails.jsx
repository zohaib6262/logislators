              ...
              !representative?.extras?.extraPoints?.description || (
                <div className="bg-[#4B2E2E] text-white rounded-xl px-6 py-4 shadow-md">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    <div className="font-semibold sm:w-1/2">
                      {representative.extras.extraPoints.bills}
                    </div>
                    <p className="sm:w-2/3">
                      {` ${representative.extras.extraPoints.description} `}
                      <strong>{`${representative.extras.extraPoints.points}.`}</strong>
                    </p>
                  </div>
                </div>
              )}
...
//       ) {
//         // Mobile devices with share API support
//         const response = await fetch(dataUrl);
//         const blob = await response.blob();
//         const file = new File(
//           [blob],
//           `${representative.name.replace(/\s+/g, "-")}-profile.png`,
//           {
//             type: blob.type,
//           }
//         );
...
//           title: `${representative.name}'s Profile`,
//           files: [file],
//         });
//       } else {
//         // Traditional download for desktop and unsupported mobile browsers
//         const link = document.createElement("a");
//         link.download = `${representative.name.replace(
//           /\s+/g,
//           "-"
//         )}-profile.png`;
//         link.href = dataUrl;
...
//       if (error.toString().includes("share")) {
//         alert("Sharing failed. Trying download instead...");
...
//       } else {
//         alert(
//           "Download failed. Please try again or take a screenshot instead."
//         );
//       }
//     }
//   };
...
//             <button
//               onClick={() => handleDownload(representative)}
//               className="flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition duration-200 w-full sm:w-auto"
//             >
//               <Download className="w-5 h-5 mr-2" />
//               Download PDF
//             </button>
